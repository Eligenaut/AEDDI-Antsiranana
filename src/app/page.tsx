...
export default function HomePage() {
  return (
    <div className="flex flex-col-reverse lg:flex-row min-h-screen lg:h-screen lg:overflow-hidden">
      <div className="w-full lg:w-1/2 bg-white p-0 md:p-4 lg:p-6 flex flex-col flex-1 lg:overflow-hidden">
        <AccueilContent />
      </div>     
