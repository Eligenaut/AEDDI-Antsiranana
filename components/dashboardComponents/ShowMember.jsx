...
export function ShowMember({ isOpen, onClose, memberId }) {
  ...
  useEffect(() => { setMounted(true); }, []); // ✅ ajouté
              ...
              {loading ? (
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    {member.avatar ? (
                      <img src={member.avatar} alt="avatar" className="w-20 h-20 rounded-full border-4 border-blue-100 mx-auto mb-4 shadow-lg" />
                    ) : (
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <div className="text-sm font-medium text-gray-700 mb-2">Type de compte</div>
                      <div className="flex items-center space-x-2">
                        {member.google_id ? (
                          <><div className="w-2 h-2 bg-green-500 rounded-full" /><span className="font-medium">Google</span></>
                        ) : (
                          <><div className="w-2 h-2 bg-blue-500 rounded-full" /><span className="font-medium">Classique</span></>
                        )}
                      </div>
                    </div>
                  </div>
